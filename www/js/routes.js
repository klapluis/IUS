angular.module('app.routes', [])
        ...
        .config(function($stateProvider, $urlRouterProvider) {
            $stateProvider
                    ...
                    .state('buscarUnidadSalud', {
                        url: '/buscarUnidadSalud',
                        templateUrl: 'templates/buscarUnidadSalud.html',
                        controller: 'buscarUnidadSaludCtrl'
                    })
                    ...
                    .state('informacionEspecialidad', {
                        url: '/informacionE/:id',
                        templateUrl: 'templates/informacionEspecialidad.html',
                        controller: 'informacionEspecialidadCtrl'
                    })
